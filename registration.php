...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $verify_link = 'http://http://chechobikes.com/verify.php?email=' . $to . '&token=' . $token;
        $message = '
...
<a href="' . $verify_link . '">' . $verify_link . '</a>';
        ...
        try {
            ...
            //Destinatarios
            $mail->setFrom('camibal1995@gmail.com', 'Admin');          //Este es el correo electrónico desde el que envía su formulario
            ...
            $mail->send();
            echo "<script>alert('Revisa tu corréo electrónico y activa tu cuenta')</script>";
        } catch (Exception $e) {
