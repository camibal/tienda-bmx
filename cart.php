...
?>
    ...
    <?php else : ?>
        <script>
            alert('La cantidad se actualizó exitosamente');
        </script>
    <?php endif; ?>
<?php
...
<div class="page">
    <div class="container">
        <div class="text-danger">
            Si deseas modificar la cantidad debes modificarla y dar click en actualizacion de la compra *
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="cart-buttons">
                            <ul>
                                <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                    ...
                                    <!-- <li>
                                        <a href="" data-toggle="modal" data-target="#confirmOrder">modal</a>
                                        <a href="https://wa.me/573202075715?text=<?php echo "PRODUCTO: $arr_cart_p_name[$i] - " . PHP_EOL, "TALLA: $arr_cart_size_name[$i] - " . PHP_EOL, "COLOR: $arr_cart_color_name[$i] - " . PHP_EOL, "CANTIDAD: $arr_cart_p_qty[$i] - " . PHP_EOL, "PRECIO: $table_total_price" . PHP_EOL ?>" class="btn btn-primary" target="_blank">
                                            <i class="fa fa-whatsapp text-success"></i> Solicitar pedido
                                        </a>
                                    </li> -->
                                <?php endfor; ?>
                            </ul>
