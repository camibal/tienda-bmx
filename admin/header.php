	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Tienda Virtual</span>
			</a>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview <?php if ($cur_page == 'index.php') {
						...
						<a href="index.php">
							<i class="fa fa-hand-o-right"></i> <span>Inicio</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'settings.php')) {
						...
						<a href="settings.php">
							<i class="fa fa-hand-o-right"></i> <span>Configuración del sitio web</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php')) {
						...
						<a href="product.php">
							<i class="fa fa-hand-o-right"></i> <span>Ver / Agregar productos</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'order.php')) {
						...
						<a href="order.php">
							<i class="fa fa-hand-o-right"></i> <span>Gestion de pedidos</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'customer.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php')) {
						...
						<a href="customer.php">
							<i class="fa fa-hand-o-right"></i> <span>Cliente</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'page.php')) {
						...
						<a href="page.php">
							<i class="fa fa-hand-o-right"></i> <span>Página</span>
						</a>
					</li>
					...
					<li class="treeview <?php if (($cur_page == 'social-media.php')) {
						...
						<a href="videos.php">
							<i class="fa fa-hand-o-right"></i> <span>Sección Videos</span>
						</a>
					</li>
					<li class="treeview <?php if (($cur_page == 'social-media.php')) {
											echo 'active';
						...
						<a href="events.php">
							<i class="fa fa-hand-o-right"></i> <span>Sección Eventos</span>
						</a>
					</li>
					<li class="treeview <?php if (($cur_page == 'social-media.php')) {
											echo 'active';
						...
						<a href="bmx.php">
							<i class="fa fa-hand-o-right"></i> <span>Videos Bmx</span>
						</a>
					</li>
					<li class="treeview <?php if (($cur_page == 'social-media.php')) {
											echo 'active';
						...
						<a href="mtb.php">
							<i class="fa fa-hand-o-right"></i> <span>Videos MTB</span>
						</a>
					</li>
					<li class="treeview <?php if (($cur_page == 'social-media.php')) {
											echo 'active';
						...
						<a href="ruta.php">
							<i class="fa fa-hand-o-right"></i> <span>Videos RUTA</span>
						</a>
					</li>
