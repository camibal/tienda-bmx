            ...
            <div class="col-md-12">
                ...
                <?php if (!isset($_SESSION['customer'])) : ?>
                    <p style="text-align: center;">
                        Inicia Sesión para poder continuar con tu compra <br><br>
                        ...
                        <?php if ($checkout_access == 0) : ?>
                            <div class="col-md-12">
                                <div style="color:red;font-size:22px;margin-bottom:50px;">
                                    You must have to fill up all the billing and shipping information from your dashboard panel in order to checkout the order. up the information going to <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">this link</a>.
                                </div>
                            </div>
                        <?php else : ?>
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <form class="paypal" action="payment/paypal/payment_process.php" method="post" id="">
                                        <h3 for="" class="d-content"><?php echo LANG_VALUE_34; ?>: </h3>
